...
export async function buildFloorPlanFromData() {
  ...
  labels.push(label('客廳 Living Room', W * 0.55, 1.5, D * 0.75));
  labels.push(label('臥室 Bedroom 1', W * 0.35, 1.5, D * 0.65));
  labels.push(label('臥室 Bedroom 2', W * 0.82, 1.5, D * 0.65));
  labels.push(label('浴廁 Bathroom', W * 0.45, 1.5, D * 0.3));
