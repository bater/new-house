...
全家冷氣採 **一台室外主機 + 三台室內機（one-to-three）** 配置，室外主機放在 F 陽台上層（見 [三層配置](#三層垂直堆疊配置)），室內機分別供應 [A 客廳](A)、[B 主臥](B)、[C 次臥](C)。
...
- [ ] 室內機位置：
  ...
  - **B 主臥**：位置待定（[BN](../walls/BN) / [BS](../walls/BS) / [BE](../walls/BE) 擇一，避開 [BE 的 LD002 翻轉床](../walls/BE)）
  - **C 次臥**：位置待定（需避開 [CW 的 KL Board 翻轉床](../walls/CW) + [架高夾層](C) 上方儲藏）
...
|---|---|---|---|
| [A 客廳 + 廚房](A) | 8–10 坪 | 3.6–4.0 kW | 36 或 40 |
| [B 主臥](B) | 3–4 坪 | 2.2–2.8 kW | 22 或 28 |
| [C 次臥](C) | 3–4 坪 | 2.2–2.8 kW | 22 或 28 |
