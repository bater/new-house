...
**B 房衣櫃牆** — 主臥的衣物收納，與 [BE 的 LD002 翻轉床](BE.md) 分工互補。
...
<!-- ![描述](/assets/images/walls/BW/example.jpg) -->

## 參考產品 / 圖片

### 模組化壁面收納 (modular wall shelving)

![BW 模組化壁面收納參考](../assets/images/walls/BW/modular-shelf-ref.png){: .hover-lightbox-trigger width="600" }
...
![BW 頂天立地掛衣架參考](../assets/images/walls/BW/tension-wardrobe-ref.png){: .hover-lightbox-trigger width="400" }
